...
- **Grocery list** with **Walmart / WinCo aisle navigation** (side + depth), on-screen **store layout maps** (illustrated + aisle diagram per chain), comparable **item costs**, approximate **cart total**, and third-party grocery links  

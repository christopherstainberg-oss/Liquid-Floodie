...
- **Grocery list** with **Walmart / WinCo aisle navigation for Medford, OR** (Supercenter #2069 / #5839 · WinCo #44 Barnett Rd; side + depth), on-screen **store layout maps** (illustrated + aisle diagram per chain), comparable **item costs**, approximate **cart total**, and third-party grocery links  
